...
class SharedPrefs {
  ...
  static String getString(String key, {String defValue = ""}) => _prefsInstance.getString(key) ?? defValue;
  static void setString(String key, String value) async => _prefsInstance.setString(key, value);


  static bool getBool(String key, {bool defValue = false}) => _prefsInstance.getBool(key) ?? defValue;
  static void setBool(String key, bool value) async => _prefsInstance.setBool(key, value);

  static int getInt(String key, {int defValue = 0}) => _prefsInstance.getInt(key) ?? defValue;
  static void setInt(String key, int value) async => _prefsInstance.setInt(key, value);


  static double getDouble(String key, {double defValue = 0.0}) => _prefsInstance.getDouble(key) ?? defValue;
  static void setDouble(String key, double value) async => _prefsInstance.setDouble(key, value);

  //Getter setter for StringList Values
  static List<String> getStringList(String key) => _prefsInstance.getStringList(key) ?? <String>[];
  static void setStringList(String key, List<String> value) async => _prefsInstance.setStringList(key, value);
